...
const O4 = () => {
  useEffect(() => {
    ...
    gsap.fromTo(
      '.txt4',
      { y: 200, opacity: 0 },
      { y: 0, opacity: 1, duration: 0.6,  ease: 'power2.out', scrollTrigger: { trigger: '.pro4', start: 'top 90%', end: 'bottom center' } }
    );
    gsap.fromTo(
      '.txt44',
      { y: 200, opacity: 0 },
      { y: 0, opacity: 1, duration: 0.7,  ease: 'power2.out', scrollTrigger: { trigger: '.pro44', start: 'top 90%', end: 'bottom center' } }
    )
    gsap.fromTo(
      '.txt444',
      { y: 200, opacity: 0 },
      { y: 0, opacity: 1, duration: 0.8, ease: 'power2.out', scrollTrigger: { trigger: '.pro444', start: 'top 90%', end: 'bottom center' } }
    );
  }, []);
  return (
<div className="o4">
